...
// Issue (admin only). Enforces the review-before-issue gate. Optionally accepts
// the Final Certificate PDF (multipart 'file') — the only file the platform stores.
router.post('/:id/issue', requireAuth(['super_admin']), uploadSingle('file'), documentController.issueDocument);
