...
const certSchema = new mongoose.Schema({
  ...
  // Workflow: the reviewer assigned to this certification case. Can be a
  // Sub-Admin (assignedReviewerId set) or the Main Admin (id null, name kept).
  assignedReviewerId: { type: mongoose.Schema.Types.ObjectId, ref: 'SubAdmin', default: null, index: true },
